...
let UploadController = class UploadController {
    ...
    async bulkUploadExams(file) {
        if (file.mimetype !== 'text/csv') {
            throw new common_1.BadRequestException('Invalid file type. Please upload a CSV.');
        }
...
], UploadController.prototype, "bulkUploadExams", null);
__decorate([
    (0, common_1.Post)('questions/:examId'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file')),
    ...
    __metadata("design:returntype", Promise)
], UploadController.prototype, "uploadQuestionsForExam", null);
